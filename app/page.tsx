...
type ProgressiveBlurHoverProps = {
  url: string
  name: string
  link: string
}
      ...
      >
        <div className="flex-1">
          <p className="text-zinc-600 dark:text-zinc-400">
            Curious child turned mobile developer — still tinkering, just with pixels and code.
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {PROJECTS.map((project) => (
            <div key={project.name} className="space-y-2">
                <ProgressiveBlurHover url={project.url} name={project.name} link={project.link} />
              <div className="px-1">
                <a
